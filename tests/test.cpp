...
void Test::testEventReader()
{
    ...
    strList.clear();
    strList.append(QString("ImageObject: id=0, filename=../img/button.png"));
    strList.append(QString("Event: type=image, start=2000, x=0, y=0, image id=0"));
    ...
    strList.clear();
    strList.append(QString("VideoObject: id=0, length=2000"));
    strList.append(QString("Event: type=record, start=0, duration=2000, videoId=0"));
    strList.append(QString("Event: type=playback, start=0, duration=2000, videoId=0"));
    QCOMPARE(evReader.loadEvents(strList, events), true);

    strList.clear();
    strList.append(QString("ImageObject: id=0, filename=../img/"));
    strList.append(QString("Event: type=image, start=2000, x=0, y=0, image id=0"));
    QCOMPARE(evReader.loadEvents(strList, events), false);

    strList.clear();
    strList.append(QString("ImageObject: id=1, filename=../img/button.png"));
    strList.append(QString("Event: type=image, start=2000, x=0, y=0, image id=0"));
    QCOMPARE(evReader.loadEvents(strList, events), false);

    strList.clear();
    strList.append(QString("VideoObject: id=0, length=1000"));
    strList.append(QString("Event: type=record, start=0, duration=2000, videoId=0"));
    strList.append(QString("Event: type=playback, start=0, duration=2000, videoId=0"));
    QCOMPARE(evReader.loadEvents(strList, events), false);
